...
Layouts only resize widgets if the size_hint is set for the respective axis.
...
Is it a coincidence that the content height is 720? YES!
Does it have anything to do with the window height? NO!
...
class LayoutView(arcade.gui.UIView):
    ...
    def __init__(self) -> None:
        ...
        self.grid.add(
            arcade.gui.UILabel(text="Arcade: ", font_name="arial"),
            row=0,
            column=0,
        )
        self.grid.add(
            arcade.gui.UILabel(text=arcade.VERSION, font_name="arial"),
            row=0,
            column=1,
        )
        self.grid.add(
